...
function draw() {
  ...
  for (var i=0; i<agents.length; i++) {
    ...
    if (agents[i].intersectingAgents.length == 2) {
      var intersectingAgent1 = agents[i].intersectingAgents[0];
      var intersectingAgent2 = agents[i].intersectingAgents[1];
      
      stroke(255, 20);
      noFill();
      triangle(agents[i].position.x, agents[i].position.y, intersectingAgent1.position.x, intersectingAgent1.position.y, intersectingAgent2.position.x, intersectingAgent2.position.y);
    }
